...
export default function Register() {
  ...
  const onSubmit = async (e)=>{
    e.preventDefault();
    await dispatch(RegisterAction(form, router))
  }
            ...
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200 border-0">
              ...
              <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                ...
                <form onSubmit={onSubmit}>
                  <SimpleInput label="Name" type="text" name="name" placeholder="Name" errors={errors.name} onChange={onChange}/>
                  ...
                  <SimpleInput label="Confirm Password" type="text" name="password2" placeholder="Confirm your password" errors={errors.password2} onChange={onChange}/>
